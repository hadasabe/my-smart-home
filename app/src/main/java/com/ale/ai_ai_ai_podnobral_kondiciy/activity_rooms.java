...
public class activity_rooms extends AppCompatActivity {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Добавить", (dialogInterface, which) -> {
                    ...
                    if (!text.isEmpty() && imageUri != null) {
                        ...
                        Toast.makeText(activity_rooms.this, "Элемент добавлен: " + text, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(activity_rooms.this, "Пожалуйста, введите текст и выберите изображение", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void goBedroom(View v){
        Intent i = new Intent(this, activity_bedroom.class);
        startActivity(i);
    }

    public void goBathroom(View v){
        Intent i = new Intent(this, activity_bathroom.class);
        startActivity(i);
    }
